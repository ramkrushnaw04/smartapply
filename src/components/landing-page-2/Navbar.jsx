    ...
    return (
        ...
        >
            ...
            <div className={`w-full mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between shadow-3xl ${isMobile ? "backdrop-blur-[7px] rounded-full " : "backdrop-blur-none "}`}>
                ...
                {!isMobile && (
                    <ContrastText>
                        <div className="flex items-center space-x-6 font-bold flex-grow ml-6">
                            <a href="#" className="navbar-links text-gray-900 hover:text-indigo-500 font-semibold transition-colors whitespace-nowrap">Jobs</a>
                            <a href="#" className="navbar-links text-gray-900 hover:text-indigo-500 font-semibold transition-colors whitespace-nowrap">Companies</a>
                            <a href="#" className="navbar-links text-gray-900 hover:text-indigo-500 font-semibold transition-colors whitespace-nowrap">Career Resources</a>
                            <a href="#" className="navbar-links text-gray-900 hover:text-indigo-500 font-semibold transition-colors whitespace-nowrap">For Employers</a>
                        </div>
                    </ContrastText>
                )}
                ...
                {!isMobile && (
                    <div className="flex items-center gap-3 ml-4 flex-shrink-0">
                        <button className="px-4 py-2 rounded-full font-semibold bg-white/40 text-indigo-500 border border-indigo-400 hover:bg-indigo-50 transition whitespace-nowrap">
                            Log In
                        </button>
